<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="机构规模" prop="jigouguimo">
          <el-input v-model="ruleForm.jigouguimo" 
              placeholder="机构规模" clearable  :readonly="ro.jigouguimo"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加盟内容" prop="jiamengneirong">
          <el-input v-model="ruleForm.jiamengneirong" 
              placeholder="加盟内容" clearable  :readonly="ro.jiamengneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加盟内容" prop="jiamengneirong">
              <el-input v-model="ruleForm.jiamengneirong" 
                placeholder="加盟内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="加盟日期" prop="jiamengriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiamengriqi" 
                type="date"
                placeholder="加盟日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiamengriqi" label="加盟日期" prop="jiamengriqi">
              <el-input v-model="ruleForm.jiamengriqi" 
                placeholder="加盟日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.jiamengriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiamengfei = true;
          ...
          if(o=='jiamengneirong'){
            this.ruleForm.jiamengneirong = obj[o];
	    this.ro.jiamengneirong = true;
            continue;
          }
          if(o=='jiamengriqi'){
            this.ruleForm.jiamengriqi = obj[o];
	    this.ro.jiamengriqi = true;
            continue;
          }
          if(o=='gonghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jigoujiameng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jigoujiamengCrossAddOrUpdateFlag = false;
                  this.parent.search();
