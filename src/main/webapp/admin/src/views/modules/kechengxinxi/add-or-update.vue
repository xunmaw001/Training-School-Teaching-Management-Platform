<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="资料下载" prop="ziliaoxiazai">
          <file-upload
          tip="点击上传资料下载"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaoxiazai" label="资料下载" prop="ziliaoxiazai">
            <el-button type="text" size="small" @click="download(ruleForm.ziliaoxiazai)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../ssm4404l/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
