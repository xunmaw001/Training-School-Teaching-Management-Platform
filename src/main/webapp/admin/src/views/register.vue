  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">培训学校教学管理平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.dengji" class="input" type="text" placeholder="等级">
			   </div>
			 </div> -->
			<el-form-item label="等级" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.dengji" autocomplete="off" placeholder="等级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210315/83258d4c62e04938ac506c11c02481ed.jpg");
		height: 100vh;
